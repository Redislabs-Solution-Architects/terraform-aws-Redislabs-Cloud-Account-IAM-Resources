...
output "accessSecretKey" {
    description = "The secret access key for the redislabs-user. Decrypt thus: terraform output accessSecretKey | tr -d \" | base64 --decode | keybase pgp decrypt" 
...
output "consolePassword" {
    description = "The redislabs-user's password. Decrypt thus: terraform output consolePassword | tr -d \" | base64 --decode | keybase pgp decrypt"
